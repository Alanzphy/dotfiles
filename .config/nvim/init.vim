...
Plug 'ryanoasis/vim-devicons'                         "iconos para el explorador de archivos
Plug 'jayli/vim-easycomplete'		              "A Fast & Minimalism Style Code Completion Plugin for vim/nvim.
Plug 'SirVer/ultisnips'                               "A Fast & Minimalism Style Code Completion Plugin for vim/nvim.
...
Plug 'HerringtonDarkholme/yats.vim'                   "Yet Another TypeScript Syntax file for Vim, adapted from YAJS.
Plug 'mattn/vim-notification'			                    "Message notification system for Vim
...
colorscheme palenight                							 	  "activar el tema
...
let g:airline_theme='palenight'	"el tema de airline
